...
user2 = sender;
 ...
 if (data.status === 404) {
  ...
  if (subscribed === false) {
   ...
   client.say(channel, `${username}, ${user} é inscrito em ${canal} há ${subCumulative} meses | Sub acaba em: ${dateStreak}  | Próximo aniversário em: ${dateCumulative} | Sub: ${typeFixed} | Tier: ${tier} `) 
}
