...
user2 = sender;
 ...
 if (data.status === 404) {
  ...
  if (subscribed === false) {
   ...
   client.say(channel, `${username}, ${user} é inscrito em ${canal} há ${subCumulative} meses | Sub acaba em: ${dateStreak}  | Próximo aniversário em: ${dateCumulative} | Sub: ${type.charAt(0).toUpperCase + type.slice(1)} | Tier: ${tier} `) 
}
